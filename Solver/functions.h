...
DEF_FUNCTION (SUB, 2) //Subtraction
...
DEF_FUNCTION (COS, 13) //Cosine
DEF_FUNCTION (TAN, 14) //Tangent
DEF_FUNCTION (CTN, 15) //Cotangent
DEF_FUNCTION (ASN, 16) //Arcsine
DEF_FUNCTION (ACS, 17) //Arccosine
DEF_FUNCTION (ATN, 18) //Arctangent
DEF_FUNCTION (ACN, 19) //Arccatangent
DEF_FUNCTION (SIH, 20) //Hyperbolic sine
